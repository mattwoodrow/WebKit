...
inline ViewTransitionName RenderStyle::initialViewTransitionName() { return ViewTransitionName::createWithNone(); }
...
inline ViewTransitionName RenderStyle::viewTransitionName() const { return m_nonInheritedData->rareData->viewTransitionName; }
